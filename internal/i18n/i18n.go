...
var translations = map[Language]map[string]string{
	Romanian: {
		...
		"rsvp.attending":          "Doriți să participați?",
		"rsvp.yes_attending":      "Da, confirm prezența!",
		"rsvp.no_attending":       "Nu, nu pot să particip!",
		"rsvp.come_alone":         "Vin singur/ă",
		"rsvp.come_with_partner":  "Vin însoțit/ă",
		"rsvp.partner_name":       "Numele partenerului/partenerei",
		"rsvp.partner_name_help":  "Vă rugăm introduceți numele complet",
		"rsvp.have_kids":          "Veniți însoțiți de copii?",
		"rsvp.yes_kids":           "Da",
		"rsvp.no_kids":            "Nu",
		"rsvp.how_many_kids":      "Câți copii?",
	...
	English: {
		...
		"rsvp.restaurant":         "Restaurant: {{.RestaurantName}}",
		"rsvp.attending":          "Do you wish to participate?",
		"rsvp.yes_attending":      "Yes, I confirm my attendance!",
		"rsvp.no_attending":       "No, I cannot participate!",
		"rsvp.come_alone":         "Coming alone",
		"rsvp.come_with_partner":  "Coming with partner",
		"rsvp.partner_name":       "Partner's name",
		"rsvp.partner_name_help":  "Please enter full name",
		"rsvp.have_kids":          "Are you bringing kids?",
		"rsvp.yes_kids":           "Yes",
		"rsvp.no_kids":            "No",
		"rsvp.how_many_kids":      "How many kids?",
